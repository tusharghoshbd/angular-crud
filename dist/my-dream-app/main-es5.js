...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.changeLng = function () {
...
var I18nService = /** @class */ (function () {
    ...
    I18nService.prototype.getTranslation = function (phrase, variableData) {
        if (variableData === void 0) { variableData = null; }
        return this.data && this.data[phrase] ? this.data[phrase] : phrase;
    };
    I18nService.prototype.fetch = function (locale) {
        var _this = this;
        var langFilePath = "assets/langs/" + locale + ".json";
    ...
    I18nService.prototype.fetchFile = function (url) {
        return this.http.get(this.getBaseUrl() + url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) { return (data.data || data); }));
    };
    I18nService.prototype.getBaseUrl = function () {
